			...
			<div style="height:510px;width:1002px;">
				<div class="left-panel">
					<center>
						...
						<br>
						<br>
						<a href="update_books_manager.jsp" class="link1">Add Updates</a>
					</center>
				</div>
				<div class="content">
					<center>
						<form action="updates_books1_manager.jsp" method="post" onclick="return false">
							<h3>Add Updates</h3>
							...
							<br>
							<input type="submit" value="ADD" class="input2" onclick="return update_book_manager();">
						</form>
						<div class="content4">
							<h3>All Updates</h3>
