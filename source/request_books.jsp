...
<%
	...
	session.setAttribute("subject","request");
%>
<%
	String name="";
				...
				<div class="content">
					...
					<table border="0">
						<tr>
							...
							<td width="100px"><b><center>Request</center></b></td>
						</tr>
						<tr>
						</tr>
					</table>
					...
					<table border="1px">
						<%
							String query1="select * from books_result where count='1' or count='2'";
						...
						<tr>
							...
							<%
							if(rs_query1.getInt("count")==1)
							{
							%>
								<td width="100px">
								<form action="request_sending.jsp" method="post">
									<input type="hidden" name="isbn" value="<%=rs_query1.getString("ISBN")%>" style="border:0px;">
									<input type="submit" value="Send Request">
								</form>
								</td>
							<%	
							}
							else if(rs_query1.getInt("count")==2)
							{
							%>
								<td width="100px">
									Request sent
