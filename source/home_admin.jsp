			...
			<div style="height:510px;width:1002px;">
				...
				<div class="content">
					...
					<div class="slide_content" id="slide_content">
						...
						<slide><div class="inner_content" id="c0"><img src="images/21.jpg"></div></slide>
				...
				<h3>&nbsp;Responsibilities of Admin user:</h3>
					<ul>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						The Libray admin is responsible for providing library and research services for the organization and
						maintenance of the library and its collections. Adding books and users are main reponsibilities of the admin.
					</ul>
					<ul>
						<h4>Main Activities</h4>
						<li style="margin-left:40px;">Maintain trasactions of books in the library.</li>
						<li style="margin-left:40px;">View total books in the library.</li>
						<li style="margin-left:40px;">Add new updates about books and library.</li>
