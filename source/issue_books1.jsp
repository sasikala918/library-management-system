...
<%
	...
	session.setAttribute("issue_id",uid1);
	session.setAttribute("issue_isbn",isbn);
	ArrayList<String>list1=new ArrayList<String>();
	ArrayList<String>list2=new ArrayList<String>();
	String str="select * from books_user where uid='"+uid1+"' and ISBN='"+isbn+"' and status='1'";
			...
			<div class="data" style="height:550px;">
				...
				<div style="height:510px;width:1002px;">
					...
					<div class="content">
						<center>
							<h3>Issue Books</h3>
							<form action="issue_books1.jsp" method="post">
								<table>
									<tr>
										<td width="250px">
							...
							<table>
								...
								<tr height="100px;">
									<td colspan="2">
										<form action="issue_book2.jsp" method="post">
										<center><input type="submit" value="Issue" class="input2" name="type"></center>
										</form>
									</td>
									<td colspan="2">
										<form action="issue_book2.jsp" method="post">
											<center><input type="submit" value="Reject" class="input2" name="type" style="background-color:red;"></center>
										</form>
									</td>
								</tr>
							</table>
