...
<%
	...
	session.setAttribute("subject","search");
%>
<%
	String name="";
		...
		<div class="data" style="height:550px;">
			...
			<div style="height:510px;width:1002px;">
				<div class="left-panel">
					<center>
						<br>
						<a href="search_books.jsp" class="link1">Search Books</a>
						<br>
						<br>
				...
				<div class="content">
					...
					<table border="0">
						<tr>
							...
							<td width="100px"><b><center>Added Date</center></b></td>
						</tr>
					</table>
					</div>
					<div class="content4">
					<table border="1px">
						...
						<tr>
							...
							<td width="100px"><%=rs_query1.getString("date")%></td>
						</tr>
						<%
							}
						%>
